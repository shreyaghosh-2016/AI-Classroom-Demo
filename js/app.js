...
const views = { homeView: document.querySelector('#homeView'), problemView: document.querySelector('#problemView'), searchView: document.querySelector('#searchView'), mazeView: document.querySelector('#mazeView'), cspView: document.querySelector('#cspView'), mdpView: document.querySelector('#mdpView'), alphaBetaView: document.querySelector('#alphaBetaView') };
